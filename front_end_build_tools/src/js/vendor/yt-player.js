...
/* Adapted slightly from https://github.com/feross/yt-player */
...
class YouTubePlayer extends EventEmitter {
  ...
  _loadIframeAPI (cb) {
    ...
    /**
     * Updated AW - it appears that the original call to `loadScript` wasn't
     * playing well for some reason
     */
    if(!isLoading){
      /**
      ...
      let fScript = document.getElementsByTagName('script')[0];
